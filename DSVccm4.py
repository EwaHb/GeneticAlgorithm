...
class DSVccm4:
    ...
    def run(self, k, printRate):
        ...
        def first_part_GA(k):
            cont = 1
            print(
                "--------------------------------------------------------- Genetic Algorithm with a Country Constraint M4 --------------------------------------------------------- \n")
...
#print(math.ceil(80*0.15))
#print(math.ceil(80*1.3))
#DSVproblem = DSVccm4(50,60,3,3)
#DSVproblem.run(1,False)
